...
/**
 * DTO para requisições de atualização de tarefa.
 * <p>
 * Esta classe representa os dados que podem ser atualizados em uma tarefa existente.
 * O status não pode ser alterado através deste DTO, apenas através de ações específicas.
 * </p>
 *
...
public class TaskUpdateRequest {
    ...
    @Schema(description = "Nome da tarefa", example = "Implementar autenticação JWT - Atualizada", required = true)
    private String name;
    ...
    @Schema(description = "Descrição detalhada da tarefa",
            example = "Implementar sistema de autenticação utilizando JWT tokens com refresh token")
    ...
    @Schema(description = "Nível de prioridade da tarefa", example = "HIGH", required = true)
    private Priority priority;

    /**
     * Nova data prevista para conclusão.
     * <p>
